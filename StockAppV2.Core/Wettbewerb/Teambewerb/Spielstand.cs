...
public interface ISpielstand
{
	...
	/// <summary>
	/// Setzt den Wert <see cref="IsSetByHand"/> auf False
	/// </summary>
	void UnLock();
	...
	event EventHandler SetByHandChanged;
}
...
public class Spielstand : ISpielstand
{
	...
	protected virtual void RaiseSetByHandChanged()
	{
		var handler = SetByHandChanged;
		handler?.Invoke(this, EventArgs.Empty);
	}
