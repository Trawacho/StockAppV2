...
namespace StockApp.Comm.NetMqStockTV
{
    ...
    public class StockTV : IStockTV
    {
        ...
        public string FW => _mDNSInformation.FW;
        public string IPAddress => _mDNSInformation.IpAddress;
        public string HostName => _mDNSInformation.HostName;
        public DomainName DomainName => _mDNSInformation.DomainName;
        ...
        /// Default-Konstruktor
        /// </summary>
        /// <param name="mDnsInformation"></param>
        internal StockTV(IMDnsInformation mDnsInformation)
        {
            _mDNSInformation = mDnsInformation;
