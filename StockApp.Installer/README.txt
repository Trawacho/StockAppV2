...
..StockAppV2>dotnet publish StockApp.UI\StockApp.UI.csproj -r win-x64 -c Release -p:Version=1.8.0.0 --sc 
...
dotnet publish StockApp.UI\StockApp.UI.csproj -r win-x64 -c Release -p:Version=1.8.0.0 --sc 
