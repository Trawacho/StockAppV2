...
public static class XmlHelper
{
	...
	public static float ParseFloat(string str)
    {
        ...
        if (read)
            ...
            _log?.Error(String.Format("An error happened while parsing float value. ({0}).", str));
    ...
    public static PointF ParsePointF(string str)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing PointF value. ({0}).", str));
        }
    ...
    public static Size ParseSize(string str)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing Size value. ({0}).", str));
        }
    ...
    public static SizeF ParseSizeF(string str)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing SizeF value. ({0}).", str));
        }
    ...
    public static List<int> ParseIntList(string str)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing List of ints. ({0}).", str));
        }
    ...
    public static Color ParseColor(string xmlColor, Color byDefault)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing color value. ({0}).", xmlColor));
        }
...
#pragma warning disable IDE0057 // Use range operator
    public static int ParsePointReference(string content)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing point reference. ({0}).", content));
        }
...
#pragma warning restore IDE0057 // Use range operator
    ...
    public static Bitmap ParseImageFromBase64(string base64)
    {
        ...
        {
            _log?.Error("An error happened while parsing bitmap value.");
        }
    ...
    public static Rectangle ParseRectangle(string rectangleString)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing Rectangle value. ({0}).", rectangleString));
        }
    ...
    public static RectangleF ParseRectangleF(string str)
    {
        ...
        {
            _log?.Error(String.Format("An error happened while parsing RectangleF value. ({0}).", str));
        }
    ...
    {
        bool parsed = Enum.TryParse<TEnum>(str, out TEnum result);
