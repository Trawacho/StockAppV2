...
public class OptionsViewModel : ViewModelBase
{
	...
	public IEnumerable<string> TeamInfos { get; init; }
	...
	public OptionsViewModel(ITurnierStore turnierStore)
	{
		...
		TeamInfos = Enum.GetNames(typeof(TeamInfo));
	}
	...
	public string TeamInfoToPrint
	{
		get => Enum.GetName(TeamBewerb.TeamInfo);
		set
		{
			TeamBewerb.TeamInfo = Enum.TryParse(value, out TeamInfo teamInfo) ? teamInfo : TeamInfo.Keine;
			RaisePropertyChanged();
		}
	}
